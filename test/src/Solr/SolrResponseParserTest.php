...
final class SolrResponseParserTest extends TestCase {
    ...
    {
        $jsonResponse = file_get_contents('test/resources/solr-queries/solr_response_sample.json');
    ...
    {
        $jsonResponse = file_get_contents('test/resources/solr-queries/solr_response_stats.json');
        $parser = new SolrResponseParser(json_decode($jsonResponse));
    ...
    {
        $jsonResponse = file_get_contents('test/resources/solr-queries/solr_response_facetQueries.json');
        $parser = new SolrResponseParser(json_decode($jsonResponse));
