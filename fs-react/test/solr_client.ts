...
describe('getParams()', function () {
    it('search text one word', function () {
        let params = initSolr().getParams("test", [], [], [], [], [], "", null, []);
...
describe('getParams()', function () {
    it('search text 2 words', function () {
        let params = initSolr().getParams("test test2", [], [], [], [], [], "", null, []);
        console.log(params.toString());
...
describe('getParams()', function () {
    it('attributeFacets with 1 value for a property', function () {
        ...
        let params = initSolr().getParams("test", attributeFacets, [], [], [], [], "", null, []);
        console.log(params.toString());
...
describe('getParams()', function () {
    it('propertyFacets with 1 value for a property', function () {
        ...
        let params = initSolr().getParams("test", propertyFacets, [], [], [], [], "", null, []);
        console.log(params.toString());
...
describe('getParams()', function () {
    it('categoryFacets', function () {
        ...
        let params = initSolr().getParams("test", [], [], categoryFacets, [], [], "", null, []);
        console.log(params.toString());
...
describe('getParams()', function () {
    it('namespaceFacets', function () {
        ...
        let params = initSolr().getParams("test", [], [], [], namespaceFacets, [], "", null, []);
        console.log(params.toString());
...
describe('getParams()', function () {
    it('extraProperties', function () {
        ...
        let params = initSolr().getParams("test", [], [], [], [], extraProperties, "", null, []);
        console.log(params.toString());
